...
`systemctl-tui` can quickly browse service and timer status and logs, start/stop/restart/reload units, and view/edit unit files. It aims to do a small number of things well.
